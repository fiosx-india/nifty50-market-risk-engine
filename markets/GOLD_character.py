"""Market character: GOLD. Research layer only; no hard-coded market result."""
...
MARKET_CHARACTER = MarketCharacter(
    market='GOLD',
    market_type='precious_metal_financial_asset',
    identity='Gold market connecting monetary policy, reserves, investment, jewellery, technology and safe-haven demand.',
    core_drivers=('real yields', 'USD', 'central banks', 'ETF/investment flows', 'geopolitics', 'inflation', 'jewellery', 'mine supply', 'recycling'),
    upstream=('gold mines', 'refiners', 'recyclers', 'central-bank reserves'),
    processing=('refining', 'bullion', 'bars/coins', 'jewellery manufacturing', 'recycling'),
    downstream=('jewellery', 'investment products', 'reserves', 'electronics', 'gold-backed finance'),
    demand_sectors=('jewellery', 'financial services', 'asset management', 'electronics', 'luxury retail', 'gold lending'),
    supply_chain_channels=('mine -> refiner', 'refiner -> bullion', 'bullion -> jewellery', 'price -> demand', 'price -> recycling'),
    direct_exposure_patterns=('gold inventory', 'jewellery procurement', 'gold-backed lending', 'mining'),
    indirect_exposure_patterns=('wealth effect', 'safe haven', 'real rates', 'INR gold price', 'consumer affordability'),
    cost_channels=('gold procurement', 'working capital', 'hedging', 'refining'),
    revenue_channels=('jewellery sales', 'investment flows', 'gold lending', 'mining realization'),
    macro_channels=('real yields', 'inflation', 'USD/INR', 'rates', 'liquidity', 'risk aversion'),
    global_channels=('LBMA/COMEX', 'US real yields', 'DXY', 'central banks', 'geopolitics', 'ETFs'),
    event_triggers=('gold-price shock', 'inventory', 'jewellery demand', 'gold-loan book', 'central-bank policy'),
    indicators=('USD gold return', 'INR gold return', 'real-yield change', 'DXY', 'gold volatility', 'ETF flows', 'central-bank demand', 'gold/silver ratio'),
